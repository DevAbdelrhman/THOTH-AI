<p align="center">
  <picture>
    ...
    <img src="./frontend/public/logo-black.svg" alt="THOTH Chat" width="160" />
  </picture>
</p>
...
<p align="center">
  <a href="https://thoth.com"><img alt="Website" src="https://img.shields.io/badge/Website-thoth.com-black" /></a>
  <a href="https://thoth.com/docs/thoth-chat/quickstart"><img alt="Guide" src="https://img.shields.io/badge/Guide-Quickstart-0f766e" /></a>
  <a href="https://t.me/thoth_chat"><img alt="Telegram" src="https://img.shields.io/badge/Telegram-thoth_chat-26A5E4?logo=telegram&logoColor=white" /></a>
  <a href="https://x.com/THOTH_AI"><img alt="X" src="https://img.shields.io/badge/X-%40THOTH_AI-black?logo=x&logoColor=white" /></a>
...
THOTH Chat is an open-source, deployable AI platform for individuals, teams, and enterprises that need long-term, stable, and unified access to multiple model providers. It provides one clear entry point for multiple upstream models and providers, integrating multimodal chat, model routing, files and RAG, MCP tools, usage billing, identity, audit logs, and operational controls into one product.
...
![THOTH Chat workspace](./frontend/public/THOTH-Chat.jpg)
...
<p align="center">
  <img src="./frontend/public/THOTH-Chat-Image.png" alt="THOTH Chat image generation" width="49.45%" />
  <img src="./frontend/public/THOTH-Chat-Dark.png" alt="THOTH Chat dark mode" width="49.45%" />
</p>

<p align="center">
  <img src="./frontend/public/THOTH-Chat-Usage.png" alt="THOTH Chat usage and billing" width="32.3%" />
  <img src="./frontend/public/THOTH-Chat-Artifacts.png" alt="THOTH Chat artifacts" width="32.3%" />
  <img src="./frontend/public/THOTH-Chat-Html.png" alt="THOTH Chat HTML rendering" width="32.3%" />
</p>

## Architecture and Tech Stack

THOTH Chat uses a split frontend/backend development model with a single-runtime deployment path. The frontend is built into static assets and served by the Go service, while APIs, authorization, model routing, files, billing, and audit capabilities run in the same backend runtime. Heavy document extraction and OCR capabilities are optional services, keeping the base deployment lightweight.
...
> Quick installation guide: [Quick Start](https://thoth.com/docs/thoth-chat/quickstart).
...
| Data | Container path |
| --- | --- |
| SQLite database | `/app/data/thoth.db` |
...
The default application image is `ghcr.io/thoth-ai/thoth-chat:latest`. Override it with `THOTH_CHAT_IMAGE` when testing a custom build:

```bash
THOTH_CHAT_IMAGE=thoth-chat:local docker compose up -d --build
```
...
They attach to `thoth-chat-network`; start one root compose profile first, or create the network manually with `docker network create thoth-chat-network`.
...
1. Configure public URLs.
   ...
   ```bash
   docker build --build-arg NEXT_PUBLIC_API_BASE_URL=https://api.example.com -t thoth-chat .
   ```
...
2. Build and publish the frontend.
   ...
   ```bash
   pnpm install
   NEXT_PUBLIC_API_BASE_URL=https://api.example.com pnpm --filter @thoth/web build
   ```
...
> Full configuration guide: [Configuration](https://thoth.com/docs/thoth-chat/configuration).
...
- [Quick Start](https://thoth.com/docs/thoth-chat/quickstart)
- [Configuration](https://thoth.com/docs/thoth-chat/configuration)
- [User Guide](https://thoth.com/docs/thoth-chat/new-chat)
- [Admin Guide](https://thoth.com/docs/thoth-chat/admin-accounts)
- [Advanced Guide](https://thoth.com/docs/thoth-chat/advanced-capabilities-passthrough-tools)
...
THOTH Chat is built on the open-source ecosystem. Thanks to all maintainers and communities in the AI tooling ecosystem.
