...
const FILE_LIBRARY_INVALIDATED_EVENT = "thoth-chat:file-library-invalidated";
const FILE_LIBRARY_INVALIDATED_STORAGE_KEY = "thoth-chat:file-library-invalidated:payload";
const FILE_LIBRARY_BROADCAST_CHANNEL = "thoth-chat:file-library";
