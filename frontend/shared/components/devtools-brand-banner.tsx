...
const BANNER_SCRIPT = `
(() => {
  const key = "__THOTH_CHAT_DEVTOOLS_BANNER__";
  ...
  console.log("%cOfficial: https://thoth.com  |  Repository: https://github.com/THOTH-AI/THOTH-Chat  |  License: Apache License 2.0", "color:#64748b;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace");
})();
`;

export function DevtoolsBrandBanner() {
  return (
    <Script id="thoth-devtools-brand" strategy="afterInteractive">
      {BANNER_SCRIPT}
    </Script>
  );
}
