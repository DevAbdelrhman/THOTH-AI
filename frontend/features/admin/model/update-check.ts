...
export const RELEASE_PAGE_PREFIX = "https://github.com/THOTH-AI/THOTH-Chat/releases/tag/";

const LATEST_RELEASE_CACHE_KEY = "thoth-chat:latest-release";
const LATEST_RELEASE_CHANGED_EVENT = "thoth-chat:latest-release-changed";
