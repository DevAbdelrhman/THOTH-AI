import type { UpsertIdentityProviderRequest } from "@thoth/api-contract";
...
export function buildLoginSettingsGroups(t: LoginSettingsTranslator): LoginSettingsGroup[] {
  ...
  },
  {
    ...
    fields: [
      ...
      { namespace: "auth", key: "smtp_from", label: t("fields.smtpFrom.label"), description: t("fields.smtpFrom.description"), type: "string", placeholder: "THOTH Chat <noreply@example.com>" },
