...
const CONVERSATION_ID_HEADER = [
  "X-Conversation-Id",
  `\${THOTH_CONVERSATION_ID}`,
] as const;
const SESSION_ID_HEADER = ["X-Session-Id", `\${THOTH_SESSION_ID}`] as const;
const REQUEST_ID_HEADER = ["X-Request-Id", `\${THOTH_REQUEST_ID}`] as const;
const OPENAI_CLIENT_REQUEST_ID_HEADER = [
  "X-Client-Request-Id",
  `\${THOTH_UPSTREAM_REQUEST_ID}`,
] as const;
