...
export const CHAT_FONT_STORAGE_KEY = "thoth-chat:chat-font";
export const CHAT_FONT_UPDATED_EVENT = "thoth-chat:chat-font-updated";
export const CHAT_FONT_WEIGHT_STORAGE_KEY = "thoth-chat:chat-font-weight";
export const CHAT_FONT_WEIGHT_UPDATED_EVENT = "thoth-chat:chat-font-weight-updated";
