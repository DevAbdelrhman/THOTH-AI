...
import (
	...
	"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/cache/memory"
...
func TestUpdateModelClearsAutomaticContextWindowWhenIdentityChanges(t *testing.T) {
	repo := &modelUpdateRepo{
		model: domainchannel.PlatformModel{
			...
			Vendor:            "anthropic",
			KindsJSON:         `["chat"]`,
			CapabilitiesJSON:  `{"contextWindow":200000,"_thothContextWindowMode":"auto","maxOutputTokens":8192}`,
			AccessScope:       "public",
			Status:            "active",
		},
	}
