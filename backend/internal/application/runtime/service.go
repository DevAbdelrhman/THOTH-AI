...
import (
	...
	doclingextract "github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/extract/docling"
	mineruextract "github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/extract/mineru"
	ocrextract "github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/extract/ocr"
	tikaextract "github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/extract/tika"
)

const (
	tikaContainerName      = "thoth-chat-tika"
	tikaImage              = "apache/tika:3.2.3.0"
	tesseractContainerName = "thoth-chat-tesseract"
	tesseractImage         = "thoth-chat-tesseract:latest"
	rapidOCRContainerName  = "thoth-chat-rapidocr"
	rapidOCRImage          = "thoth-chat-rapidocr:latest"
	doclingContainerName   = "thoth-chat-docling"
	doclingImage           = "thoth-chat-docling:latest"
	serviceNetwork         = "thoth-chat-network"
