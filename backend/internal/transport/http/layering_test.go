...
func TestBackendLayeringImports(t *testing.T) {
	...
	checks := []struct {
	...
	}{
		{
			dir: "transport/http",
			forbidden: []string{
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/persistence`,
		...
		},
		{
			dir: "repository",
			forbidden: []string{
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/application`,
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/transport`,
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/persistence`,
				`"github.com/gin-gonic/gin"`,
				`"gorm.io/gorm"`,
				`"github.com/redis/go-redis`,
		...
		},
		{
			...
			forbidden: []string{
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/application`,
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/transport`,
				`"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra`,
				`"github.com/gin-gonic/gin"`,
				`"gorm.io/gorm"`,
				`"github.com/redis/go-redis`,
			},
