...
import (
	...
	appauth "github.com/THOTH-AI/THOTH-Chat/backend/internal/application/auth"
...
const refreshTokenCookieName = "thoth_chat_refresh_token"
...
// @Description 为 Web、App 或桌面公共客户端创建 PKCE 保护的 OAuth 授权事务；外部身份源仅回调当前 THOTH 实例
// @Tags auth
// @Accept json
// @Produce json
