...
import (
	...
	"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/extract/pdfrender"
	...
	"github.com/THOTH-AI/THOTH-Chat/backend/internal/infra/outboundhttp"
...
const (
	...
	ManagedRapidOCRBaseURL  = "http://thoth-chat-rapidocr:8002/ocr"
	managedRapidOCRHost     = "thoth-chat-rapidocr"
...
func (c *Client) extractTextWithLLM(ctx context.Context, req Request) (Response, error) {
	...
	foundAnyImage := false
	tempDir, err := os.MkdirTemp("", "thoth-chat-llm-ocr-*")
	if err != nil {
		return Response{}, err
	}
